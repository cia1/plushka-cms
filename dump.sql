...
INSERT INTO `comment` VALUES (36,14,1,1391801260,'Администратор','12345',1,'127.0.0.1'),(34,13,1,1391801237,'Администратор','Вот это да...',1,'127.0.0.1'),(35,13,1,1391801244,'Пётр','Это тестовый комментарий.',1,'127.0.0.1'),(37,15,1,1391801275,'Администратор','54321',1,'127.0.0.1');
...
LOCK TABLES `commentGroup` WRITE;
/*!40000 ALTER TABLE `commentGroup` DISABLE KEYS */;
INSERT INTO `commentGroup` VALUES ('article/view/about',13),('article/blog/news/130411',14),('article/blog/news/13-410',15);
/*!40000 ALTER TABLE `commentGroup` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `demotivator`
--

DROP TABLE IF EXISTS `demotivator`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `demotivator` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `demotivator`
--

LOCK TABLES `demotivator` WRITE;
/*!40000 ALTER TABLE `demotivator` DISABLE KEYS */;
INSERT INTO `demotivator` VALUES (2,'Алкоголь утончает восприятие','1365782151.jpg','root',1365782151,NULL,NULL,1),(3,'Скоро пятница - я бы сдул...','1365782262.jpg','root',1365782262,NULL,NULL,1),(4,'Если в слове хеб сделать 4 ошибки...','1365782385.jpg','root',1365782385,NULL,NULL,1),(11,'','1390578841.jpg','',1390578841,NULL,NULL,0);
...
INSERT INTO `forumCategory` VALUES (1,'Category 1',1,'','','',1,1),(3,'Category 2',2,'','','',1,1);
...
INSERT INTO `forumPost` VALUES (23,8,1,1408986613,'Message 1.'),(24,8,1,1408987275,'Message 2.'),(25,8,1,1408987283,'Message 3.'),(26,8,1,1408987292,'Message 4.'),(27,8,1,1409173115,'Строка 1 строка.\r\nВтроая\r\nи треться <font style=\"color:red;\">строка</a>.'),(28,8,1,1409173878,'Пример текста <a href=\"http://ya.ru\">со ссылкой</a> и <b>жирным текстом</b>.'),(29,8,1,1409174068,'111222333'),(30,8,1,1409174304,'Тут есть всё: [b]жирный текст[/B], другой: [I]италик[/i], ещё [u]подчёркнутый[/U].\r\nВот картинка: [img]http://yabs.yandex.ru/count/CrIJezfdNre40002gP0088wph-G_1L6L0fi6QLg8itm32mUcXGcAj_VSIG6g0gMM66IGe4oRiP6yq4ba1fClGQxyAt43BlEY0GMn0Rlen37C2vRs5BxJV0CBHm1WUGe0[/img].');
...
INSERT INTO `forumTopic` VALUES (8,1,1,'Topic 1',1408985261,1409174304,8,'p oijp oqewiv jeoriuvhui hvoiu hoiuh ',1),(9,1,1,'Topic 2',1408988452,0,0,'p aoivja pvoiv jpo ij',1),(10,1,1,'Topic 3',1408988470,0,0,'pq fioje vpiwuevh oeriu houih',1);
...
INSERT INTO `forumUser` VALUES (1,'root',1408729824,'127.0.0.1','5.jpeg',11,0);
/*!40000 ALTER TABLE `forumUser` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `frmField`
--

DROP TABLE IF EXISTS `frmField`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `frmField` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `frmField`
--

LOCK TABLES `frmField` WRITE;
/*!40000 ALTER TABLE `frmField` DISABLE KEYS */;
INSERT INTO `frmField` VALUES (6,1000,'Ваше имя','text','','',1,1,'Your name',''),(7,1000,'E-mail или телефон','text','','',0,2,'E-mail or phone',''),(8,1000,'Сообщение','textarea','','',1,3,'Message',''),(9,1001,'Ваше имя','text','','',1,1,'Ваше имя',''),(10,1001,'Телефон','text','','',1,2,'Телефон',''),(11,1001,'Желаемое время звонка','text','','',1,3,'Желаемое время звонка',''),(12,1002,'Ваше имя','text','','',1,1,'Ваше имя',''),(13,1002,'Телефон','text','','',1,2,'Телефон',''),(14,1002,'Удобное время звонка','text','','',0,3,'Удобное время звонка',''),(24,1000,'Откуда вы узнали о нас?','select','поисковик|от друзей|сайт example.com|другое','',1,4,'How did you hear about us','search engine|form friends|site example.com|other'),(25,1000,'Введите текст с картинки','captcha','','',1,5,'Provide the text on the p',''),(30,999,'Телефон','text','','',0,2,'Телефон',''),(29,999,'Ваше имя','text','','',1,1,'Ваше имя',''),(31,999,'E-mail','email','','cfg',0,3,'E-mail','');
/*!40000 ALTER TABLE `frmField` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `frmForm`
--

DROP TABLE IF EXISTS `frmForm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `frmForm` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `frmForm`
--
...
INSERT INTO `menu` VALUES (1,'Верхнее'),(5,'Для покупателей');
...
INSERT INTO `menuItem` VALUES (1,0,1,1,'article/view/index','Главная',1,'Main'),(2,0,1,1,'article/view/about','О нас',2,'About us'),(3,0,1,2,'article/blog/news','Новости',4,'News'),(4,0,1,4,'article/list/article','Статьи',3,'Articles'),(6,0,1,11,'catalog/1','Каталог',5,'Catalog'),(7,0,1,6,'faq','ЧаВо',7,'F.A.Q.'),(8,0,1,5,'shop/category','Магазин',6,'Shop'),(9,29,1,9,'demotivator','Галерея',2,'Gallery'),(10,0,1,7,'form/1000','Контакты',10,'Contacts'),(29,0,1,3,'#','Демотиваторы',8,'Demotivators'),(30,29,1,8,'demotivator/construct','Конструктор',1,'Constructor'),(33,0,1,13,'forum','Форум',9,'Forum'),(34,33,1,12,'forum/profile','Профайл',1,'Profile');
...
INSERT INTO `modified` VALUES ('article/view/index',1446400070),('article/view/about',1446400100),('article/blog/news',1446402140),('article/list/news',1446402140),('article/view/130412',1446415813),('article/view/130411',1446415750),('article/view/13-410',1446415780),('article/blog/article',1446400146),('article/list/article',1446400146),('article/view/article-1',1446401835),('article/view/article-2',1446402001),('article/view/article-3',1446401859),('article/view/article-4',1446401737),('catalog/1/catalog-1',1365765458),('catalog/1/catalog-2',1365765577),('catalog/1/1',1365765814),('catalog/1/colleague',1435661929),('catalog/1/vaselisa-prekrasnaya',1382800559),('catalog/1/where-you-bagira',1382799016),('catalog/1/podkidiysh',1382799066),('catalog/1/oiyugiuyg',1382799315),('catalog/1/tmp',1386702794),('catalog/1/2',1386703433),('shop/category/4/morozko-2835-60',1409634219),('shop/category/37/germaflex-yd-kw02-45',1427971093),('shop/category/37/huter-bs-45',1427971071),('shop/category/37/flo-500',1427971085),('shop/category/38/bass-bp-5310',1416615975),('shop/category/39/fubag-auto-master-kit',1427971134),('shop/category/39/germaflex-500l-w20-8',1427971125),('shop/category/39/genesis-11-08-500',1427971114),('shop/category/39/genesis-i-22-4-10',1427971106),('article/view/example',1418384536),('catalog/1/iuygiuyg',1419694739);
...
INSERT INTO `section` VALUES ('bottom','article/blog/news*',9,1),('bottom','article/list/article*',9,1),('right','article/view/index.',10,2),('right','article/view/index.',11,3),('footer','catalog/1/',51,1),('right','article/view/about.',13,4),('right','article/list/article/',13,4),('right','article/view/about.',16,5),('right','faq.',16,5),('right','form/1000/',16,5),('right','article/view/about.',17,6),('right','form/1000/',17,6),('bottom','article/view/index.',53,2),('right','faq/',54,7),('right','form/1000.',54,7),('footer','faq/',51,1),('footer','#/',51,1),('footer','article/view/index/',51,1),('footer','form/1000/',51,1),('bottom','article/view/about.',9,1),('footer','article/blog/news/',51,1),('footer','article/list/article/',51,1),('footer','article/view/about/',51,1),('right','article/view/about.',58,8),('right','article/view/index.',58,8),('top','user/register.',63,1),('top','user/login.',63,1),('right','article/list/article/',66,9),('top','catalog/1/',68,2),('right','shop/',15,10),('right','article/view/index.',14,1),('right','shop/',14,1),('bottom','article/view/index.',6,3),('bottom','form/1000.',77,4);
...
--
-- Table structure for table `shpCategory`
--
...
--
-- Dumping data for table `shpCategory`
--

LOCK TABLES `shpCategory` WRITE;
/*!40000 ALTER TABLE `shpCategory` DISABLE KEYS */;
INSERT INTO `shpCategory` VALUES (35,0,'tools','Инстументы','',0,'35.jpg','12,13,14,16,17,18,21,21','','',''),(36,0,'equipment','Оборудование','',0,'36.png','16,17,18,21','','',''),(37,35,'chainsaw','Бензопилы','',0,'37.jpg','12,13,14,21','','',''),(38,35,'screwdrivers','Шуруповёрты','',0,'38.jpg','16,20','','',''),(39,36,'compressors','Компрессоры','',0,'39.jpg','18,17,21','','','');
/*!40000 ALTER TABLE `shpCategory` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `shpFeature`
--

DROP TABLE IF EXISTS `shpFeature`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shpFeature` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `shpFeature`
--
...
--
-- Table structure for table `shpFeatureGroup`
--

DROP TABLE IF EXISTS `shpFeatureGroup`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shpFeatureGroup` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `shpFeatureGroup`
--
...
--
-- Table structure for table `shpProduct`
--
...
--
-- Dumping data for table `shpProduct`
--
...
--
-- Table structure for table `shpProductFeature`
--

DROP TABLE IF EXISTS `shpProductFeature`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shpProductFeature` (
...
--
-- Dumping data for table `shpProductFeature`
--
...
--
-- Table structure for table `shpProductGroup`
--

DROP TABLE IF EXISTS `shpProductGroup`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shpProductGroup` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `shpProductGroup`
--
...
--
-- Table structure for table `shpProductGroupItem`
--

DROP TABLE IF EXISTS `shpProductGroupItem`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shpProductGroupItem` (
  `groupId` smallint(5) unsigned NOT NULL,
  `productId` int(10) unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `shpProductGroupItem`
--
...
--
-- Table structure for table `shpVariant`
--

DROP TABLE IF EXISTS `shpVariant`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shpVariant` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `productId` int(10) unsigned NOT NULL,
  `title` char(60) NOT NULL,
...
--
-- Dumping data for table `shpVariant`
--
...
INSERT INTO `user` VALUES (2,250,'admin','2fVRwDsHuyNI6',1,'admin@mail.com',''),(3,200,'moderator','2fy8kc7l/6nd6',1,'editro@mail.com',''),(1,255,'root','2fzr2Ln.VAGRA',1,'root@example.com',NULL);
...
INSERT INTO `userGroup` VALUES (255,'суперпользователь'),(250,'администратор'),(200,'модератор'),(1,'зарегистрированный');
...
INSERT INTO `userMessage` VALUES (5,2,'test-user',1,'root',1365537600,0,'Привет, мир!'),(6,1,'root',2,'test-user',1421750068,0,'Это ответ на личное сообщение.');
...
INSERT INTO `vote` VALUES (3,'Знаете ли вы что такое медитация?','почти ничего не знаю\r|что-то слышал об этом\r|да, знаю, но не практикую\r|иногда практикую\r|медитация занимает значительную часть моей жизни','0|0|0|0|0','');
...
INSERT INTO `widget` VALUES (6,'shopProductGroup','1',30,'Избранные товары',1,'bottom','Favorite Products'),(14,'shopCart','a:3:{s:7:\"product\";b:1;s:5:\"total\";b:1;s:8:\"checkout\";b:1;}',0,'Корзина',1,'right','Cart'),(15,'shopCategory','',0,'Категории',1,'right','Categories'),(9,'comment','',0,'Комментарии',1,'bottom','Comments'),(10,'demotivatorLast','',10,'Последний демотиватор',1,'right','Last Demotivator'),(11,'html','right.2',0,'Демотиватор (текст)',0,'right','Демотиватор (текст)'),(51,'html','footer.1',0,'Копирайты',0,'footer','Копирайты'),(13,'blog','a:4:{s:10:\"categoryId\";s:1:\"2\";s:8:\"linkType\";s:4:\"list\";s:12:\"countPreview\";i:0;s:9:\"countLink\";i:100;}',0,'Статьи',1,'right','Articles'),(16,'chat','a:2:{s:2:\"id\";i:1;s:5:\"count\";i:5;}',0,'Тем временем в чате...',1,'right','This time in the chat...'),(17,'form','1002',30,'Обратный звонок',1,'right','Callback'),(58,'blog','a:4:{s:10:\"categoryId\";s:1:\"1\";s:8:\"linkType\";s:4:\"blog\";s:12:\"countPreview\";i:3;s:9:\"countLink\";i:0;}',0,'Новости',1,'right','News'),(53,'html','bottom.1',0,'С праздником!!!!',1,'bottom','Happy Holidays!!!'),(54,'vote','3',10,'Голосование',1,'right','Poll'),(68,'catalogSearch','a:2:{s:2:\"id\";s:1:\"1\";s:3:\"fld\";a:2:{s:5:\"title\";b:1;s:4:\"year\";a:4:{s:3:\"min\";d:1900;s:3:\"max\";d:2015;s:4:\"step\";d:1;s:5:\"range\";b:1;}}}',0,'Поиск',1,'top','Search'),(63,'oauth','a:2:{s:8:\"register\";b:0;s:2:\"vk\";a:2:{i:0;s:3:\"111\";i:1;s:3:\"222\";}}',0,'Войти через...',0,'top','Войти через...'),(66,'html','right.3',0,'Произвольный текст',0,'right','Произвольный текст'),(77,'map','a:6:{s:2:\"id\";i:68;s:14:\"centerLatitude\";d:43.133643865585;s:15:\"centerLongitude\";d:55.958936550308998;s:4:\"zoom\";i:10;s:4:\"type\";s:7:\"ROADMAP\";s:6:\"marker\";a:1:{i:0;a:3:{s:5:\"title\";s:18:\"Я живу тут\";s:8:\"latitude\";d:43.084396439491002;s:9:\"longitude\";d:55.973300787063003;}}}',0,'Как проехать',1,'bottom','How Can I Get To');
