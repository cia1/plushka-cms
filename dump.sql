...
-- Дамп структуры для таблица cms0.adminNote
...
-- Дамп данных таблицы cms0.adminNote: ~1 rows (приблизительно)
...
-- Дамп структуры для таблица cms0.article
...
-- Дамп структуры для таблица cms0.articleCategory
...
-- Дамп данных таблицы cms0.articleCategory: 2 rows
...
-- Дамп структуры для таблица cms0.catalog_1
...
-- Дамп структуры для таблица cms0.chatBan
CREATE TABLE IF NOT EXISTS `chatBan` (
  `ip` char(26) NOT NULL,
  `date` int(10) unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Дамп данных таблицы cms0.chatBan: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `chatBan` DISABLE KEYS */;
/*!40000 ALTER TABLE `chatBan` ENABLE KEYS */;


-- Дамп структуры для таблица cms0.comment
...
-- Дамп данных таблицы cms0.comment: 4 rows
/*!40000 ALTER TABLE `comment` DISABLE KEYS */;
INSERT INTO `comment` (`id`, `groupId`, `userId`, `date`, `name`, `text`, `status`, `ip`) VALUES
	(36, 14, 5, 1391801260, 'Администратор', '12345', 1, '127.0.0.1'),
	(34, 13, 5, 1391801237, 'Администратор', 'Вот это да...', 1, '127.0.0.1'),
	(35, 13, 5, 1391801244, 'Пётр', 'Это тестовый комментарий.', 1, '127.0.0.1'),
	(37, 15, 5, 1391801275, 'Администратор', '54321', 1, '127.0.0.1');
/*!40000 ALTER TABLE `comment` ENABLE KEYS */;


-- Дамп структуры для таблица cms0.commentGroup
...
-- Дамп данных таблицы cms0.commentGroup: 3 rows
...
-- Дамп структуры для таблица cms0.demotivator
...
-- Дамп данных таблицы cms0.demotivator: 4 rows
...
-- Дамп структуры для таблица cms0.faq
...
-- Дамп данных таблицы cms0.faq: 4 rows
...
-- Дамп данных таблицы cms0.forumCategory: ~2 rows (приблизительно)
...
-- Дамп структуры для таблица cms0.forumPost
...
-- Дамп данных таблицы cms0.forumPost: ~9 rows (приблизительно)
/*!40000 ALTER TABLE `forumPost` DISABLE KEYS */;
INSERT INTO `forumPost` (`id`, `topicId`, `userId`, `date`, `message`) VALUES
	(7, 0, 0, 0, 'ouihouihouih'),
	(23, 8, 5, 1408986613, 'Message 1.'),
	(24, 8, 5, 1408987275, 'Message 2.'),
	(25, 8, 5, 1408987283, 'Message 3.'),
	(26, 8, 5, 1408987292, 'Message 4.'),
	(27, 8, 5, 1409173115, 'Строка 1 строка.\r\nВтроая\r\nи треться <font style="color:red;">строка</a>.'),
	(28, 8, 5, 1409173878, 'Пример текста <a href="http://ya.ru">со ссылкой</a> и <b>жирным текстом</b>.'),
	(29, 8, 5, 1409174068, '111222333'),
	(30, 8, 5, 1409174304, 'Тут есть всё: [b]жирный текст[/B], другой: [I]италик[/i], ещё [u]подчёркнутый[/U].\r\nВот картинка: [img]http://yabs.yandex.ru/count/CrIJezfdNre40002gP0088wph-G_1L6L0fi6QLg8itm32mUcXGcAj_VSIG6g0gMM66IGe4oRiP6yq4ba1fClGQxyAt43BlEY0GMn0Rlen37C2vRs5BxJV0CBHm1WUGe0[/img].');
/*!40000 ALTER TABLE `forumPost` ENABLE KEYS */;


-- Дамп структуры для таблица cms0.forumTopic
...
-- Дамп данных таблицы cms0.forumTopic: ~3 rows (приблизительно)
...
INSERT INTO `forumTopic` (`id`, `categoryId`, `userId`, `title`, `date`, `lastDate`, `postCount`, `message`, `status`) VALUES
	(8, 1, 5, 'Topic 1', 1408985261, 1409174304, 8, 'p oijp oqewiv jeoriuvhui hvoiu hoiuh ', 1),
	(9, 1, 5, 'Topic 2', 1408988452, 0, 0, 'p aoivja pvoiv jpo ij', 1),
	(10, 1, 5, 'Topic 3', 1408988470, 0, 0, 'pq fioje vpiwuevh oeriu houih', 1);
/*!40000 ALTER TABLE `forumTopic` ENABLE KEYS */;


-- Дамп структуры для таблица cms0.forumUser
...
-- Дамп данных таблицы cms0.forumUser: ~2 rows (приблизительно)
/*!40000 ALTER TABLE `forumUser` DISABLE KEYS */;
INSERT INTO `forumUser` (`id`, `login`, `date`, `ip`, `avatar`, `postCount`, `status`) VALUES
	(5, 'root', 1408729824, '127.0.0.1', '5.jpeg', 11, 0),
	(31, 'test-user', 1418301698, NULL, '31.jpeg', 0, 1);
/*!40000 ALTER TABLE `forumUser` ENABLE KEYS */;


-- Дамп структуры для таблица cms0.frmField
...
-- Дамп данных таблицы cms0.frmField: 16 rows
...
INSERT INTO `frmField` (`id`, `formId`, `title`, `htmlType`, `data`, `defaultValue`, `required`, `sort`) VALUES
	(1, 999, 'Ваше имя', 'text', '', '', 1, 1),
	(2, 999, 'Контактный телефон', 'text', '', '', 0, 2),
	(3, 999, 'E-mail', 'email', '', '', 0, 3),
	(4, 999, 'Примечание к заказу', 'textarea', '', '', 0, 5),
	(5, 999, 'Доставка', 'select', 'самовывоз|почта', 'самовывоз', 1, 4),
...
-- Дамп структуры для таблица cms0.frmForm
...
-- Дамп данных таблицы cms0.frmForm: 4 rows
...
INSERT INTO `frmForm` (`id`, `title`, `email`, `subject`, `successMessage`, `redirect`, `formView`, `script`) VALUES
	(999, 'Оформление заказа', 'cfg', 'cms0: заказ с сайта', '', '', '', ''),
...
-- Дамп структуры для таблица cms0.menu
...
-- Дамп данных таблицы cms0.menu: 2 rows
...
-- Дамп структуры для таблица cms0.menuItem
...
-- Дамп данных таблицы cms0.menuItem: 13 rows
...
INSERT INTO `menuItem` (`id`, `parentId`, `menuId`, `link`, `title`, `sort`, `typeId`) VALUES
	...
	(7, 0, 1, 'faq', 'ЧаВо', 7, 6),
	(8, 0, 1, 'shop/category', 'Магазин', 6, 5),
...
-- Дамп структуры для таблица cms0.menuType
...
-- Дамп данных таблицы cms0.menuType: 12 rows
...
INSERT INTO `menuType` (`id`, `title`, `controller`, `action`) VALUES
	...
	(5, 'Магазин: категории', 'shop', 'menuCategory'),
...
-- Дамп структуры для таблица cms0.modified
...
INSERT INTO `modified` (`link`, `time`) VALUES
	...
	('catalog/1/colleague', 1386684540),
	...
	('shop/category/37/germaflex-yd-kw02-45', 1411332191),
	('shop/category/37/huter-bs-45', 1411318553),
	('shop/category/37/flo-500', 1411329943),
	('shop/category/38/bass-bp-5310', 1416615975),
	('shop/category/39/fubag-auto-master-kit', 1411333023),
...
-- Дамп структуры для таблица cms0.oauth
...
-- Дамп данных таблицы cms0.oauth: 0 rows
/*!40000 ALTER TABLE `oauth` DISABLE KEYS */;
/*!40000 ALTER TABLE `oauth` ENABLE KEYS */;


-- Дамп структуры для таблица cms0.section
...
-- Дамп данных таблицы cms0.section: 33 rows
/*!40000 ALTER TABLE `section` DISABLE KEYS */;
INSERT INTO `section` (`name`, `url`, `widgetId`, `sort`) VALUES
	('bottom', 'article/view/index.', 6, 1),
	('bottom', 'article/blog/news*', 9, 3),
	('bottom', 'article/list/article*', 9, 3),
	('right', 'article/view/index.', 10, 1),
	('right', 'article/view/index.', 11, 2),
	('footer', 'catalog/1/', 51, 1),
	('right', 'article/view/about.', 13, 4),
	('right', 'article/list/article/', 13, 4),
	('right', 'shop/category/', 14, 6),
	('right', 'shop/category/', 15, 5),
	('right', 'article/view/about.', 16, 7),
	('right', 'faq.', 16, 7),
	('right', 'form/1000/', 16, 7),
	('right', 'article/view/about.', 17, 8),
	('right', 'form/1000/', 17, 8),
...
-- Дамп структуры для таблица cms0.shpCategory
...
-- Дамп данных таблицы cms0.shpCategory: 5 rows
/*!40000 ALTER TABLE `shpCategory` DISABLE KEYS */;
INSERT INTO `shpCategory` (`id`, `parentId`, `title`, `text1`, `sort`, `image`, `feature`, `metaTitle`, `metaKeyword`, `metaDescription`) VALUES
	(35, 0, 'Инстументы', '', 0, '35.jpg', '', '', '', ''),
	(36, 0, 'Оборудование', '', 0, '36.png', '', '', '', ''),
	(37, 35, 'Бензопилы', '', 0, '37.jpg', '13,11,14,12', '', '', ''),
	(38, 35, 'Шуруповёрты', '', 0, '38.jpg', '15,16,20', '', '', ''),
	(39, 36, 'Компрессоры', '', 0, '39.jpg', '17,18,19', '', '', '');
/*!40000 ALTER TABLE `shpCategory` ENABLE KEYS */;


-- Дамп структуры для таблица cms0.shpFeature
...
-- Дамп данных таблицы cms0.shpFeatureGroup: ~4 rows (приблизительно)
...
-- Дамп структуры для таблица cms0.shpProduct
...
-- Дамп данных таблицы cms0.shpProductFeature: ~22 rows (приблизительно)
...
-- Дамп структуры для таблица cms0.shpProductGroup
...
-- Дамп данных таблицы cms0.shpProductGroup: 1 rows
...
-- Дамп структуры для таблица cms0.shpProductGroupItem
CREATE TABLE IF NOT EXISTS `shpProductGroupItem` (
  `groupId` smallint(5) unsigned NOT NULL,
  `productId` int(10) unsigned NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- Дамп данных таблицы cms0.shpProductGroupItem: 2 rows
...
-- Дамп структуры для таблица cms0.shpVariant
...
-- Дамп данных таблицы cms0.shpVariant: ~1 rows (приблизительно)
...
-- Дамп структуры для таблица cms0.user
...
-- Дамп данных таблицы cms0.user: 4 rows
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` (`id`, `groupId`, `login`, `password`, `status`, `email`, `code`) VALUES
	(3, 250, 'admin', 'pwd13pwd', 1, 'admin@mail.com', ''),
	(4, 200, 'moderator', 'pwd13pwd', 1, 'editro@mail.com', ''),
	(5, 255, 'root', 'masterkey', 1, 'root@example.com', ''),
	(31, 1, 'test-user', 'pwd13pwd', 1, 'test-user@example.com', NULL);
/*!40000 ALTER TABLE `user` ENABLE KEYS */;


-- Дамп структуры для таблица cms0.userGroup
...
-- Дамп данных таблицы cms0.userGroup: 4 rows
...
-- Дамп структуры для таблица cms0.userMessage
...
-- Дамп данных таблицы cms0.userMessage: 0 rows
/*!40000 ALTER TABLE `userMessage` DISABLE KEYS */;
/*!40000 ALTER TABLE `userMessage` ENABLE KEYS */;


-- Дамп структуры для таблица cms0.userRight
...
-- Дамп данных таблицы cms0.userRight: 32 rows
...
INSERT INTO `userRight` (`module`, `groupId`, `description`, `picture`) VALUES
	...
	('shop.setting', '250', 'Магазин: настройки', 'shopSetting'),
	('shop.category', '250', 'Магазин: категории', NULL),
	('shop.product', '250', 'Магазин: товары', NULL),
	...
	('catalog.layout', '', 'Каталог: управление макетами', NULL),
	...
	('shop.feature', '250', 'Магазин: характеристики товаров', NULL),
	('shop.variant', '', 'Магазин: варианты (модификации) товаров', NULL),
...
-- Дамп структуры для таблица cms0.vote
...
-- Дамп данных таблицы cms0.vote: ~1 rows (приблизительно)
...
-- Дамп структуры для таблица cms0.widget
...
-- Дамп структуры для таблица cms0.widgetType
...
-- Дамп данных таблицы cms0.widgetType: 15 rows
...
INSERT INTO `widgetType` (`name`, `title`, `controller`, `action`) VALUES
	...
	('shopProductGroup', 'Магазин: группа товаров', 'shop', 'widgetProductGroup'),
	('shopCategory', 'Магазин: категории', 'shop', 'widgetCategory'),
	('shopCart', 'Магазин: корзина', 'shop', 'widgetCart'),
