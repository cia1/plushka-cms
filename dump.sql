...
-- Дамп структуры для таблица cms.admin_note
...
-- Дамп данных таблицы cms.admin_note: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `admin_note` DISABLE KEYS */;
INSERT INTO `admin_note` (`id`, `groupView`, `groupEdit`, `title`, `html`) VALUES
...
-- Дамп структуры для таблица cms.article_category_en
DROP TABLE IF EXISTS `article_category_en`;
CREATE TABLE IF NOT EXISTS `article_category_en` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
...
-- Дамп данных таблицы cms.article_category_en: 2 rows
/*!40000 ALTER TABLE `article_category_en` DISABLE KEYS */;
INSERT INTO `article_category_en` (`id`, `parentId`, `title`, `metaTitle`, `metaKeyword`, `metaDescription`, `alias`, `text1`, `text2`, `onPage`) VALUES
...
/*!40000 ALTER TABLE `article_category_en` ENABLE KEYS */;

-- Дамп структуры для таблица cms.article_category_ru
DROP TABLE IF EXISTS `article_category_ru`;
CREATE TABLE IF NOT EXISTS `article_category_ru` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `parentId` smallint(5) unsigned NOT NULL,
  `alias` char(35) NOT NULL,
  `title` varchar(35) NOT NULL,
...
-- Дамп данных таблицы cms.article_en: 10 rows
...
INSERT INTO `article_en` (`id`, `categoryId`, `alias`, `title`, `text1`, `text2`, `sort`, `metaTitle`, `metaKeyword`, `metaDescription`, `date`) VALUES
	...
	(10, 1, '180828', 'Мажорная 4.0 версия', '<p>jhiuyg</p>', '<p>poioiuhoiuhouih</p>', 0, 'Плюшка 4.0', 'плюшка, 4.0, cms', 'Вышла мажорная версия CMS Плюшка 4.0', 1535403600);
...
-- Дамп структуры для таблица cms.comment_group
...
-- Дамп данных таблицы cms.comment_group: 3 rows
/*!40000 ALTER TABLE `comment_group` DISABLE KEYS */;
INSERT INTO `comment_group` (`link`, `id`) VALUES
	('article/view/about', 13),
	('article/blog/news/130411', 14),
	('article/blog/news/13-410', 15);
/*!40000 ALTER TABLE `comment_group` ENABLE KEYS */;
...
-- Дамп структуры для таблица cms.forum_category
...
-- Дамп данных таблицы cms.forum_category: ~2 rows (приблизительно)
/*!40000 ALTER TABLE `forum_category` DISABLE KEYS */;
INSERT INTO `forum_category` (`id`, `title`, `sort`, `metaTitle`, `metaKeyword`, `metaDescription`, `newTopic`, `newPost`) VALUES
	(1, 'Category 1', 1, '', '', '', 1, 1),
	(3, 'Category 2', 2, '', '', '', 1, 1);
/*!40000 ALTER TABLE `forum_category` ENABLE KEYS */;

-- Дамп структуры для таблица cms.forum_post
...
-- Дамп данных таблицы cms.forum_post: ~8 rows (приблизительно)
/*!40000 ALTER TABLE `forum_post` DISABLE KEYS */;
INSERT INTO `forum_post` (`id`, `topicId`, `userId`, `date`, `message`) VALUES
...
-- Дамп структуры для таблица cms.forum_topic
...
-- Дамп данных таблицы cms.forum_topic: ~3 rows (приблизительно)
/*!40000 ALTER TABLE `forum_topic` DISABLE KEYS */;
INSERT INTO `forum_topic` (`id`, `categoryId`, `userId`, `title`, `date`, `lastDate`, `postCount`, `message`, `status`) VALUES
...
-- Дамп структуры для таблица cms.forum_user
...
-- Дамп данных таблицы cms.forum_user: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `forum_user` DISABLE KEYS */;
INSERT INTO `forum_user` (`id`, `login`, `date`, `ip`, `avatar`, `postCount`, `status`) VALUES
	(1, 'root', 1408729824, '127.0.0.1', '5.jpeg', 11, 0);
/*!40000 ALTER TABLE `forum_user` ENABLE KEYS */;

-- Дамп структуры для таблица cms.frm_field
DROP TABLE IF EXISTS `frm_field`;
CREATE TABLE IF NOT EXISTS `frm_field` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
...
-- Дамп данных таблицы cms.frm_field: 14 rows
/*!40000 ALTER TABLE `frm_field` DISABLE KEYS */;
INSERT INTO `frm_field` (`id`, `formId`, `title_ru`, `htmlType`, `data_ru`, `defaultValue`, `required`, `sort`, `title_en`, `data_en`) VALUES
...
/*!40000 ALTER TABLE `frm_field` ENABLE KEYS */;

-- Дамп структуры для таблица cms.frm_form
...
-- Дамп данных таблицы cms.frm_form: 4 rows
/*!40000 ALTER TABLE `frm_form` DISABLE KEYS */;
INSERT INTO `frm_form` (`id`, `title_ru`, `email`, `subject_ru`, `successMessage_ru`, `redirect`, `formView`, `script`, `title_en`, `subject_en`, `successMessage_en`, `notification`) VALUES
...
/*!40000 ALTER TABLE `frm_form` ENABLE KEYS */;
...
-- Дамп данных таблицы cms.menu_item: 14 rows
/*!40000 ALTER TABLE `menu_item` DISABLE KEYS */;
INSERT INTO `menu_item` (`id`, `parentId`, `menuId`, `typeId`, `link`, `title_ru`, `sort`, `title_en`) VALUES
...
-- Дамп структуры для таблица cms.menu_type
...
-- Дамп данных таблицы cms.menu_type: 13 rows
/*!40000 ALTER TABLE `menu_type` DISABLE KEYS */;
INSERT INTO `menu_type` (`id`, `title`, `controller`, `action`) VALUES
...
-- Дамп структуры для таблица cms.shp_brand
DROP TABLE IF EXISTS `shp_brand`;
CREATE TABLE IF NOT EXISTS `shp_brand` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
...
-- Дамп данных таблицы cms.shp_brand: ~5 rows (приблизительно)
/*!40000 ALTER TABLE `shp_brand` DISABLE KEYS */;
INSERT INTO `shp_brand` (`id`, `title`, `image`, `text1`) VALUES
	(2, 'FLO', '2.jpeg', ''),
	(3, 'HUTER', '3.png', ''),
	(4, 'GERMAFLEX', '4.jpeg', ''),
	(5, 'ABAC', '5.jpeg', ''),
	(6, 'Fubag', '6.gif', '');
/*!40000 ALTER TABLE `shp_brand` ENABLE KEYS */;

-- Дамп структуры для таблица cms.shp_category
DROP TABLE IF EXISTS `shp_category`;
CREATE TABLE IF NOT EXISTS `shp_category` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `parentId` smallint(5) unsigned NOT NULL DEFAULT '0',
...
-- Дамп данных таблицы cms.shp_category: ~5 rows (приблизительно)
/*!40000 ALTER TABLE `shp_category` DISABLE KEYS */;
INSERT INTO `shp_category` (`id`, `parentId`, `alias`, `title`, `text1`, `sort`, `image`, `feature`, `metaTitle`, `metaKeyword`, `metaDescription`) VALUES
...
/*!40000 ALTER TABLE `shp_category` ENABLE KEYS */;

-- Дамп структуры для таблица cms.shp_feature
DROP TABLE IF EXISTS `shp_feature`;
CREATE TABLE IF NOT EXISTS `shp_feature` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
...
-- Дамп данных таблицы cms.shp_feature: ~8 rows (приблизительно)
/*!40000 ALTER TABLE `shp_feature` DISABLE KEYS */;
INSERT INTO `shp_feature` (`id`, `type`, `groupId`, `title`, `unit`, `variant`, `data`) VALUES
...
/*!40000 ALTER TABLE `shp_feature` ENABLE KEYS */;

-- Дамп структуры для таблица cms.shp_feature_group
DROP TABLE IF EXISTS `shp_feature_group`;
CREATE TABLE IF NOT EXISTS `shp_feature_group` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;

-- Дамп данных таблицы cms.shp_feature_group: ~4 rows (приблизительно)
/*!40000 ALTER TABLE `shp_feature_group` DISABLE KEYS */;
INSERT INTO `shp_feature_group` (`id`, `title`) VALUES
	(4, 'Бензопилы'),
	(5, 'Электроинструмент'),
	(6, 'Компрессоры'),
	(7, 'Общие');
/*!40000 ALTER TABLE `shp_feature_group` ENABLE KEYS */;

-- Дамп структуры для таблица cms.shp_product
DROP TABLE IF EXISTS `shp_product`;
CREATE TABLE IF NOT EXISTS `shp_product` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `categoryId` smallint(5) unsigned NOT NULL,
...
-- Дамп данных таблицы cms.shp_product: ~8 rows (приблизительно)
/*!40000 ALTER TABLE `shp_product` DISABLE KEYS */;
INSERT INTO `shp_product` (`id`, `categoryId`, `brandId`, `alias`, `title`, `text1`, `text2`, `price`, `mainImage`, `image`, `metaTitle`, `metaKeyword`, `metaDescription`, `variant`, `quantity`) VALUES
...
/*!40000 ALTER TABLE `shp_product` ENABLE KEYS */;

-- Дамп структуры для таблица cms.shp_product_feature
DROP TABLE IF EXISTS `shp_product_feature`;
CREATE TABLE IF NOT EXISTS `shp_product_feature` (
  `productId` int(10) unsigned NOT NULL,
  `featureId` smallint(5) unsigned NOT NULL,
  `value` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Дамп данных таблицы cms.shp_product_feature: ~23 rows (приблизительно)
/*!40000 ALTER TABLE `shp_product_feature` DISABLE KEYS */;
INSERT INTO `shp_product_feature` (`productId`, `featureId`, `value`) VALUES
	(61, 16, '0-900 об/мин'),
	(61, 20, '1.7 кг'),
	(59, 12, '450 мм'),
	(59, 13, '0.83 мм'),
	...
	(60, 12, '500 мм'),
	(60, 21, '2200 Вт');
/*!40000 ALTER TABLE `shp_product_feature` ENABLE KEYS */;

-- Дамп структуры для таблица cms.shp_product_group
DROP TABLE IF EXISTS `shp_product_group`;
CREATE TABLE IF NOT EXISTS `shp_product_group` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `title` char(30) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- Дамп данных таблицы cms.shp_product_group: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `shp_product_group` DISABLE KEYS */;
INSERT INTO `shp_product_group` (`id`, `title`) VALUES
	(1, 'Избранные товары');
/*!40000 ALTER TABLE `shp_product_group` ENABLE KEYS */;

-- Дамп структуры для таблица cms.shp_product_group_item
DROP TABLE IF EXISTS `shp_product_group_item`;
CREATE TABLE IF NOT EXISTS `shp_product_group_item` (
  `groupId` smallint(5) unsigned NOT NULL,
  `productId` int(10) unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Дамп данных таблицы cms.shp_product_group_item: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `shp_product_group_item` DISABLE KEYS */;
INSERT INTO `shp_product_group_item` (`groupId`, `productId`) VALUES
	(1, 61);
/*!40000 ALTER TABLE `shp_product_group_item` ENABLE KEYS */;

-- Дамп структуры для таблица cms.shp_variant
DROP TABLE IF EXISTS `shp_variant`;
CREATE TABLE IF NOT EXISTS `shp_variant` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `productId` int(10) unsigned NOT NULL,
  `title` char(60) NOT NULL,
...
-- Дамп данных таблицы cms.shp_variant: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `shp_variant` DISABLE KEYS */;
INSERT INTO `shp_variant` (`id`, `productId`, `title`, `feature`) VALUES
	(1, 59, 'HUTER BS-45M', 'a:1:{i:12;s:8:"400 мм";}');
/*!40000 ALTER TABLE `shp_variant` ENABLE KEYS */;
...
-- Дамп структуры для таблица cms.user_group
...
-- Дамп данных таблицы cms.user_group: 4 rows
...
-- Дамп структуры для таблица cms.user_message
...
-- Дамп данных таблицы cms.user_message: 2 rows
/*!40000 ALTER TABLE `user_message` DISABLE KEYS */;
INSERT INTO `user_message` (`id`, `user1Id`, `user1Login`, `user2Id`, `user2Login`, `date`, `isNew`, `message`) VALUES
	(5, 2, 'test-user', 1, 'root', 1365537600, 0, 'Привет, мир!'),
	(6, 1, 'root', 2, 'test-user', 1421750068, 0, 'Это ответ на личное сообщение.');
/*!40000 ALTER TABLE `user_message` ENABLE KEYS */;

-- Дамп структуры для таблица cms.user_right
...
-- Дамп данных таблицы cms.user_right: 40 rows
/*!40000 ALTER TABLE `user_right` DISABLE KEYS */;
INSERT INTO `user_right` (`module`, `groupId`, `description`, `picture`) VALUES
	...
	('documentation.*', '255', 'Техническая документация', 'documentation');
...
INSERT INTO `vote` (`id`, `question`, `answer`, `result`, `ip`) VALUES
	(3, 'Знаете ли вы что такое медитация?', 'почти ничего не знаю\r|что-то слышал об этом\r|да, знаю, но не практикую\r|иногда практикую\r|медитация занимает значительную часть моей жизни', '1|0|0|0|0', '127.0.0.1');
...
INSERT INTO `widget` (`id`, `groupId`, `name`, `data`, `cache`, `title_ru`, `publicTitle`, `section`, `title_en`, `cssClass`) VALUES
	...
	(77, NULL, 'map', 'a:8:{s:2:"id";i:68;s:14:"centerLatitude";d:43.133643865585;s:15:"centerLongitude";d:55.958936550309;s:4:"zoom";i:10;s:4:"type";s:7:"ROADMAP";s:6:"marker";a:0:{}s:6:"apiKey";s:39:"AIzaSyCLwzK-TxjSGGgcZeuuTY5wAwRRKwQs8_Y";s:8:"provider";s:3:"osm";}', 0, 'Как проехать', 1, 'bottom', 'How Can I Get To', NULL);
/*!40000 ALTER TABLE `widget` ENABLE KEYS */;

-- Дамп структуры для таблица cms.widget_type
...
-- Дамп данных таблицы cms.widget_type: 19 rows
/*!40000 ALTER TABLE `widget_type` DISABLE KEYS */;
INSERT INTO `widget_type` (`name`, `title`, `controller`, `action`) VALUES
