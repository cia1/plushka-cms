...
class Email {
	...
	public function __construct($smtpHost=null,$smtpPort=null,$smtpUser=null,$smtpPassword=null) {
		if($smtpHost!==null) $this->_smtpHost=$smtpHost;
		if($smtpPort!==null) $this->_smtpPort=$smtpPort;
		if($smtpUser!==null) $this->_smtpUser=$smtpUser;
		if($smtpPassword!==null) $this->_smtpPassword=$smtpPassword;
	}
