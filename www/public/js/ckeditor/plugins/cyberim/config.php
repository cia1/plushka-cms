...
session_start();
if($_SESSION['user']->group<200) exit;
...
$conf['filesystem.path']='/public/';
//относительный путь к файлам пользователя
$conf['filesystem.files_path']='../../../../';
...
$conf['filesystem.allowed_extensions']='gif|png|jpeg|jpg|jpe|pdf|rtf|doc|xls|docx';
...
$conf['filesystem.max_file_size']=209715200;
...
$conf['thumbnail.width']=70;
//высота изображения предварительного просмотра
$conf['thumbnail.hieght']=70;
