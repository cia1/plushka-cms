...
class MapMarkerWidget extends Widget {
	...
	public function __invoke() {
		...
		if(!isset($this->options['formFieldLatitude'])) $this->options['formFieldLatitude']=plushka::$controller->url[0].'[latitude]';
		if(!isset($this->options['formFieldLongitude'])) $this->options['formFieldLongitude']=plushka::$controller->url[0].'[longitude]';
