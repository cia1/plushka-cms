...
foreach($this->layout as $item) { ?>
	...
	<a href="#" onclick="return moveUp('<?=$item['index']?>');"><img src="<?=core::url()?>admin/public/icon/up16.png" alt="Вверх" title="Поднять выше" /></a>
	<a href="#" onclick="return moveDown('<?=$item['index']?>');"><img src="<?=core::url()?>admin/public/icon/down16.png" alt="Вниз" title="Опустить ниже" /></a>
	</div>
<?php }
?>
</div>
