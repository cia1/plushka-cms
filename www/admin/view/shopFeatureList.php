Группа характеристик: <select id="featureGroup" style="width:400px" onchange="document.location='<?=core::link('?controller=shop&action=featureList')?>&gid='+this.value;">
...
&nbsp;&nbsp;<a href="#" onclick="featureGroupDelete();return false;"><img src="<?=core::url()?>admin/public/icon/delete16.png" alt="удалить" title="удалить всю группу"  style="position:relative;top:4px;" /></a>
<div id="feature"></div>
...
document.featureLink='<?=core::link('?controller=shop&action=featureList')?>';
</script>