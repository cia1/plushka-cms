...
class PaymentController extends Controller {
	...
	function __construct() {
		parent::__construct();
		if(count($this->url)<3) throw new HTTPException(404);
		$this->payment=Payment::instance(lcfirst($this->url[1]));
		if(!$this->payment) throw new HTTPException(404);
	...
	public function actionModelMethod() {
		...
		if(!method_exists($this->payment,$action)) throw new HTTPException(404);
