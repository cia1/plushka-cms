...
class User extends Model {
	...
	public function attribute(string $attribute,$value=null) {
		...
		if($this->_attribute===null) {
			...
			if($this->_attribute) $this->_attribute=json_decode($this->_attribute,true); else $this->_attribute=[];
		}
		if($value!==null) {
	...
	protected function rule(): array {
		$data=[
			'id'=>['primary'],
			'login'=>['callback',LNGlogin,true,[$this,'validateLogin']],
			'password'=>['callback',LNGpassword,true,[$this,'validatePassword']],
